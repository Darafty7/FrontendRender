    ...
    <body class="text-center">
      ...
      <main class="form-signin w-100 m-auto text-center shadow-lg p-3 mb-5">
        ...
        <form @submit.prevent =postRegister()>
          ...
          <div class="form-floating">
            <input type="number" class="form-control rounded-4 mb-1" id="telefono"
              v-model="persona.telefono" required>
          ...
          <div class="form-floating ">
            <select class=" color-form form-select pt-1 rounded-4 mb-1 " id="rol" 
              v-model.lazy="persona.rol" required>
